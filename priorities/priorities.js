(function(root,factory){
  ...
  function inferredOpportunityActor(raw,text){
    ...
    if(/European Commission|EEAS|European Central Bank|European Investment Bank|EuroHPC|Joint Research Centre|Council of the European Union|European Research Council|Marie Skłodowska-Curie|ERA Portal|European Investment Bank/i.test(source)) return source;
  ...
  function topicKey(x){
    ...
    const groups=[
      ['coercion-sanctions',/coercion|weaponi[sz]|sanction|restrictive measures|retaliat/],
      ['materials-energy',/critical raw|critical mineral|rare earth|gallium|graphite|lng|gas supply|energy security/],
      ['technology-security',/export control|dual-use|dual use|technology leakage|semiconductor|chip|quantum/],
      ['investment',/fdi|investment screening|takeover|acquisition|foreign subsidies|state-owned/],
      ['trade',/tariff|anti-dumping|anti-subsidy|overcapacity|trade defen[cs]e|wto|market access/],
      ['industry-defence',/manufactur|industrial|defen[cs]e|ammunition|factory|plant/],
      ['infrastructure',/critical infrastructure|cable|pipeline|port|grid|5g|vendor/],
      ['partnerships',/china|united states|india|japan|partnership|trade agreement|g7|like-minded/],
      ['supply-chains',/supply chain|supplier|dependenc|diversif|stockpil/],
      ['finance',/payment|euro|capital markets|swift/],
    ];
  ...
  function friendlyCandidateTopic(x){
    let raw=clean(x?.topicLabel||x?.objectKey||x?.title||'Europe’s economic security');
