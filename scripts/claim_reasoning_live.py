...
_FAMILY_LABELS = {
    ...
    "defence": "the defence industry",
    "green": "the clean transition",
    "health": "health supply security",
    ...
    "capital_markets": "European capital markets",
    "economic_security_strategy": "the economic-security toolbox",
    "econsec": "the economic-security toolbox",
    "supply_dependencies": "supply dependencies",
    "dependency": "strategic dependencies",
    "supply_chain": "supply chains",
    "trade_policy": "trade policy",
    "trade": "trade",
    "trade_defence": "trade defence",
    "investment_screening": "investment screening",
    "fdi": "foreign investment",
    "outbound_investment": "outbound investment",
    "foreign_subsidies": "foreign subsidies",
    "coercion_sanctions": "coercion and sanctions",
    ...
    "finance_payments": "finance and payments",
    "infrastructure": "critical infrastructure",
    "industry": "industrial capacity",
    "medicines_supply": "medicines supply",
    "medicines": "medicines supply",
...
_SHOCK_TITLES: dict[str, tuple[str, ...]] = {
    ...
    "security_reclassification": (
        "A trading partner could turn {asset} into leverage against Europe.",
        "Europe's dependence on {asset} could become the pressure point in a political dispute.",
        "Coercion aimed at {asset} could test whether Europe answers together.",
    ),
    "conflict": (
        "A wider conflict could pull people and money away from {asset}.",
        "If fighting spreads, the routes {asset} relies on could close.",
