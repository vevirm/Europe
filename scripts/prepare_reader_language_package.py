...
You are reviewing **presentation wording only** for a website on Europe's economic security (trade, investment, supply chains, coercion and partnerships).
...
## House style (from STYLE.md)

- Reader text answers two questions: WHAT the source says or does, and WHY it matters for Europe's
  economic security. A WHY that would fit an unrelated website is too generic.
- Surface word budgets: Matrix WHAT ≤ 12 words, WHY ≤ 15; Radar WHAT ≤ 20, WHY ≤ 20; page
  introduction ≤ 50 words and starting with a claim; section lead-in ≤ 25 words.
- Expand specialist abbreviations on the surface: FDI → foreign direct investment, ACI → anti-coercion
  instrument, CRMA → Critical Raw Materials Act, FSR → Foreign Subsidies Regulation, MFF → EU long-term
  budget, LNG → liquefied natural gas. WTO, EU, G7 and NATO may stay.
- Prefer concrete subjects and verbs: who controls, who supplies, what becomes dependent, what becomes
  more expensive, which partner changes position.
- Name the actor in coercion and trade disputes plainly; do not soften or dramatise it.
- Never end a sentence with an ellipsis. One idea per sentence. No throat-clearing, adjective stacks or
  rhetorical-question openers.
- Neutral, factual tone. Do not adopt any government's or outlet's framing (for example "unfair",
  "hostile", "bullying") unless the source is quoting it, and then say whose word it is.
...
Heavy: "Diversification, stockpiling or partnership-based de-risking is widening around critical raw material dependencies."
Clearer: "Europe is doing more to reduce its dependence on a few suppliers of critical raw materials."

Heavy: "Forward-looking pathways to loss that are supported by the source."
Clearer: "Ways current developments could weaken Europe’s economic security."
