"""Europe's economic security in 2035: four scenario worlds, each with four variants (16 cards).
...
* Two critical uncertainties form the axes. Both are read from the published
  Trends page each scan, so the frame moves with the evidence:
    - MORE CONNECTED <-> LESS CONNECTED: how open is Europe to global trade, investment and partners?
    - MORE RESOURCES <-> FEWER RESOURCES: how much industrial capacity, energy, capital and supply security does Europe have?
...
# ---------------------------------------------------------------- axis tagging
_OPEN_OBJECTS = (
    "trade.agreement", "trade.market_access", "trade.wto_compatibility", "partnership.", "fdi.inbound_flows",
...
_GUARD_OBJECTS = (
    "fdi.screening", "outbound_investment.", "foreign_subsidies.", "trade_defence.", "trade.eu_countermeasures",
    "coercion.anti_coercion", "sanctions.", "infrastructure.high_risk_vendor", "industry.european_preference", "econsec.",
...
_SCALE_OBJECTS = (
    "industry.manufacturing_capacity", "defence.production_capacity", "supply_chain.", "energy.", "medicines.",
...
_WORLDS = {
    ("open", "scaling"): {
        ...
        "story": (
            "Europe enters 2035 with more industrial capacity, energy and capital, while staying open to global trade and investment. "
            "Firms trade and invest across borders easily, and diversified partners spread the risk of any one supplier."
        ),
    ...
    ("guarded", "scaling"): {
        ...
        "story": (
            "By 2035, strong European investment has built more industrial and technology capacity, but Europe trades and invests with a narrower circle of partners. "
            "Screening, trade defence and European preference shape who can supply, invest and compete."
        ),
        "cost": "The trade-off is reach: Europe has more control, but pays in higher prices, retaliation and lost access to some markets and partners.",
    },
    ("open", "squeezed"): {
        ...
        "story": (
            "Europe stays open to trade and investment in 2035, but with thin industrial capacity and little supply buffer. "
            "Goods and capital move easily, while Europe depends on outside suppliers, capital and markets for what it needs."
        ),
        "cost": "The trade-off is dependence: Europe stays open, but can be coerced wherever a single supplier or market dominates.",
    },
    ("guarded", "squeezed"): {
        "id": "quiet_retreat",
        ...
        "story": (
            "In 2035, Europe has less capacity and weaker global economic links. "
            "Governments protect a smaller core of strategic industries, while trade partners retaliate and new investment becomes harder to attract."
        ),
        "cost": "The trade-off is ambition: Europe reduces exposure, but has less capacity to produce, invest and compete at scale.",
    },
}
