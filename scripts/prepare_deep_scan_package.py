...
### Strand A — substantive European economic-security work

European relevance must be substantive and supported by the work/source. A non-European study does not
qualify merely because the EU is mentioned, used as one comparator, or could have an imagined European
implication. The work needs a genuine connection to Europe's economic security: its dependencies and
security of supply, industrial capacity, trade or investment exposure, control of critical technologies,
critical infrastructure, exposure to coercion or sanctions, or its partnerships with other economies.

Do **not** require the work to use the words "economic security". A can qualify through any of three
source-grounded routes:
1. a direct or clearly supported geoeconomic relationship (coercion, leverage, dependence, screening,
   export controls, sanctions, trade defence, de-risking, partnerships);
2. evidence about a consequential European state or trajectory in an economic-security domain (for
   example import concentration, supplier diversification, stockpiles, refining or production capacity,
   inbound/outbound investment and ownership, market access, tariff or sanctions effects, energy supply,
   critical-infrastructure ownership or vendors, defence-industrial capacity); or
3. a high-quality completed evidence-led study/report whose substantive object is the EU's economic-security
   policy or toolbox itself (strategy, risk assessment, instruments, institutional competence, coordination
   with member states or partners), including analysis of the trade-off between protection and openness.

Route 3 is not a generic-economy waiver. Ordinary macroeconomics, generic firm performance, local/sector
studies without a strategic or cross-border mechanism, promotional/event pages, and work where Europe is
merely a comparator remain out.

**Alignment rule with the automatic scanner:** after the common hard guards are satisfied (verified identity,
trustworthy source, substantive European scope, central economic-security subject, and a substantive evidence
product), **any one** of Routes 1, 2, or 3 is sufficient for Strand A.

### Strand B — not used

This radar has no Strand B. Do not target B; a methods paper qualifies only if it also meets Strand A.
...
new policy decision, trade or investment measure, sanctions or export-control change, legislative development,
supply disruption, evidence release or comparable substantive event.
...
- A historical row may arrive as A or legacy/unclassified. `keep` / `review` may target only **A**. Do not target B or C.
