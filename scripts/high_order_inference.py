...
TOPICS: dict[str, tuple[str, str]] = {
    ...
    "chips": (r"\b(?:chip|chips|semiconductor|microelectronics|lithography)\b", "semiconductors"),
    "talent": (r"\b(?:fdi|foreign direct investment|acquisition|takeover|stake|ownership|investor|sovereign wealth|greenfield)\b", "investment and ownership"),
    "research_security": (r"\b(?:export control|dual[- ]use|technology security|technology leakage|entity list|outbound investment)\b", "technology security/export controls"),
    "openness": (r"\b(?:open trade|openness|market access|free trade|wto|multilateral|trade liberali[sz])\b", "trade openness"),
    "funding_programme": (r"\b(?:anti-coercion|fdi screening|screening regulation|foreign subsidies regulation|critical raw materials act|industrial accelerator act|trade defen[cs]e|sanctions package|economic security strategy|toolbox)\b", "EU economic-security instruments"),
    "health_data": (r"\b(?:medicines?|pharmaceutical|active pharmaceutical ingredient|antibiotic|medical supply)\b", "medicines supply"),
    "materials_energy": (r"\b(?:grid|electricity|energy|gas|lng|oil|critical raw material|critical material|critical mineral|rare earth|magnet|gallium|germanium)\b", "energy/materials"),
    "infrastructure": (r"\b(?:critical infrastructure|port|ports|subsea cable|undersea cable|telecom|5g|pipeline|infrastructure)\b", "critical infrastructure"),
    "collaboration_diplomacy": (r"\b(?:trade agreement|free trade agreement|partnership|like-minded|g7|global gateway|mercosur|cptpp)\b", "partnerships/agreements"),
    "startups_scaleup": (r"\b(?:manufactur|factory|plant|industry|industrial|company|companies|firm|firms|production)\b", "industry and firms"),
    "standards_testing": (r"\b(?:standard|standards|certif|conformity|interoperab)\b", "standards"),
    "measurement": (r"\b(?:index|indicator|metric|measure|measurement|monitoring|stress test|risk assessment)\b", "measurement/risk assessment"),
    "research_data": (r"\b(?:supply chain|value chain|import depend|single supplier|supplier concentration|diversif|stockpil)\b", "supply chains"),
}

CONCEPTS: dict[str, tuple[str, str]] = {
    "sovereignty": (r"\b(?:strategic autonomy|open strategic autonomy|economic sovereignty|technological sovereignty)\b", "strategic autonomy/sovereignty"),
    "resilience": (r"\b(?:resilien|security of supply|de-risk|derisk|diversif)\b", "resilience/de-risking"),
    "competitiveness": (r"\bcompetitiveness\b", "competitiveness"),
    "openness": (r"\b(?:open trade|openness|open economy|rules-based trade)\b", "openness"),
    "research_security": (r"\b(?:economic coercion|weaponi[sz]|coercive|anti-coercion)\b", "coercion/weaponised interdependence"),
}
...
_SYSTEM_TOPICS = (
    ...
    "funding_programme", "collaboration_diplomacy", "startups_scaleup", "research_security",
)
    ...
    axes = (
        {
            ...
            "summary": "Europe is opening access while adding security and dual-use safeguards to the same research or innovation area.",
            "left_plain": "Europe is opening up access and sharing in {topic}.",
            "right_plain": "Europe is adding tighter security and dual-use controls in {topic}.",
        ...
        },
        {
            ...
            "summary": "Europe is pushing {topic} toward deployment and scale while also adding standards, testing and safeguards.",
            "left_plain": "Europe is investing more and pushing {topic} toward deployment and scale.",
            "right_plain": "At the same time, Europe is adding standards, testing and safeguards for {topic}.",
        ...
        },
        {
            ...
            "summary": "Europe is trying to attract research talent while retention problems, insecure careers and skills shortages persist.",
            "left_plain": "Recruitment, mobility and career measures are drawing {topic} toward Europe.",
            "right_plain": "Retention problems, insecure careers, shortages and uneven opportunities are pulling the same workforce the other way.",
        ...
        },
        {
            ...
            "summary": "Europe is building more control and resilience in {topic}, but outside dependencies and bottlenecks remain.",
            "left_plain": "Europe is trying to gain more control and resilience in {topic}.",
            "right_plain": "Outside suppliers, capability gaps and bottlenecks still limit {topic}.",
        ...
        },
        {
            ...
            "summary": "Europe is widening research cooperation while adding tighter security and control conditions to the same partnerships.",
            "left_plain": "Cross-border cooperation on {topic} is increasing.",
            "right_plain": "Security and export-control conditions around {topic} are getting tighter.",
        ...
        },
        {
            ...
            "summary": "Europe is moving toward common rules and access in {topic}, while national and institutional differences persist.",
            "left_plain": "Europe is moving toward more common rules and access in {topic}.",
            "right_plain": "National and institutional differences still split {topic} in practice.",
        ...
        },
        {
            ...
            "summary": "Europe is adding research infrastructure, but access and availability bottlenecks still limit how much of it can be used.",
            "left_plain": "Europe is bringing new or expanded {topic} capacity online.",
            "right_plain": "Access and scarcity still limit how much of {topic} can be used.",
    ...
    for axis in axes:
        for topic in axis["topics"]:
            ...
            cand = {
                ...
                "reader_summary": axis["summary"].format(topic=topic_label),
                "trend_balance": {
                    "family": axis["id"],
                    "object_key": topic,
