...
- Authoritative V2 verified: **2** (Main **2** + Historical **0**)
- Automatic queue still needing V2 verification: **968** (Main **482** + Historical **486**)
- Currently assigned to workers: **118** (Main **118** + Historical **0**)
...
### Worker A
- Current package: `worker-a-20260925T112639Z-7b354dc9317b`
...
### Worker B
- Current package: `worker-b-20260925T112655Z-046eea0afde3`
